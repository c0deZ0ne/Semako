...
import { Cards, customerAction, userTabeData } from '../../admin-constants';
          ...
          >
            <div className=" h-[500px] relative  w-[100%] col-span-12 border rounded-lg border-1 border-[#F1F1F1] whitespace-nowrap overflow-auto scrollbar-hide">
              ...
              <div className=" grid col-span-12 grid-cols-12 max-sm:gap-10 gap-10 md:px-[24px] max-sm:mt-[200px] ">
                <div className=" h-[100%] row-span-5 flex-col  whitespace-nowrap overflow-auto scrollbar-hide max-sm:col-span-12 lg:col-span-12   flex flex-com  items-stretch md:col-span-12  w-[100%] ">
