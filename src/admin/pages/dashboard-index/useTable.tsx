...
export default function userTable({
  ...
  return (
    <TableContainer className="grid col-span-full  font-[500] text-[16px] text-[#696E7C]  w-[100%] h-[100%] whitespace-nowrap overflow-auto scrollbar-hide ">
      <Table
        className="grid grid-cols-6 bor    whitespace-nowrap overflow-auto scrollbar-hide h-[100%] font-[500] text-[16px] text-[#696E7C]  "
