...
import CustomerTable from './transactionTable';
...
function transaction() {
  ...
  const Total_Transactions = cad.find((index) => {
    return index.title == 'Total Transactions';
  });
  ...
  return (
    <div className="w-[100%] h-[100vh] max-sm:mt-10  flex-col pt-[10px] max-sm:px-[2%] lg:px-10 ">
      <div className=" w-[100%]  grid grid-cols-12 max-sm:flex max-sm:flex-col max-sm:gap-10 align-top h-[100vh] ">
              ...
              <div className=" max-sm:w-[100%]  object-cover flex  max-sm:mx-[2%] ">
                <>
                  <AppMenu
                    ...
                    props={{
                      onClick: action,
                      className: `{group text-[#565C6B] bg-white border-none w-[100%] outline-none flex w-full items-center rounded-md p-2 m-2 text-sm hover:bg-[#0099FE] hover:text-white`
                    }}
                  />
                </>
              </div>
            ...
            <div className=" h-[500px] relative  w-[100%] col-span-12 border rounded-lg border-1 border-[#F1F1F1] whitespace-nowrap overflow-auto scrollbar-hide">
              <div className=" relative   max-sm:h-[68px] md:h-[100px] md:px-[24px] flex flex-col md:flex-row   md:justify-center border-r-0 border-t-0 border-l-0 border border-b-1  ">
                ...
                <div className="flex w-[100%] gap-5   max-md:absolute max-sm:top-[60px]  justify-between  max-sm:w-[100%] max-sm:mt-[10px] max-sm:py-[10px]  md:mt-[24px] max-sm:flex max-sm:flex-col max-sm:h-[100%] h-[40px] md:items-center md:align-middle   col-span-12 ">
                  <div className=" justify-center md:items-center md:mt-auto md:mb-auto max-sm:w-[100px] max-sm:flex-col h-[48px] flex-row max-sm:gap-5 md:gap-10 relative flex md:col-span-7 md:w-[100%]   max-sm:justify-start   max-sm:mt-[20px] max-sm:mx-[2%] md:right-[0%] ">
                    <div className=" md:w-[300px] w-[307px]  h-[48px] sm:justify-center col-span-5 flex-row  flex max-sm:my-1">
                    ...
                    <AppMenu
                      ...
                      props={{
                        onClick: action,
                        className: `{group h-[100%] text-[#565C6B] border-none outline-none flex w-full items-center rounded-md px-2 py-2 text-sm hover:bg-[#0099FE] hover:text-white`
                      }}
                    />
                  </div>
                </div>
              ...
              <div className=" grid col-span-12 grid-cols-12 max-sm:gap-10 gap-10 md:px-[24px] max-sm:mt-[200px] ">
                <div className=" h-[100%] row-span-5 flex-col  whitespace-nowrap overflow-auto scrollbar-hide max-sm:col-span-12 lg:col-span-12   flex flex-com  items-stretch md:col-span-12  max-md:col-span-12  w-[100%] ">
