...
var Slider = React6.forwardRef(function Slider2(props, ref) {
  ...
  var theme = useTheme();
  var touchId = React6.useRef();
  var _React$useState = React6.useState(-1), active = _React$useState[0], setActive = _React$useState[1];
  var _React$useState2 = React6.useState(-1), open = _React$useState2[0], setOpen = _React$useState2[1];
  ...
  var _React$useState3 = React6.useState(-1), focusVisible = _React$useState3[0], setFocusVisible = _React$useState3[1];
  var sliderRef = React6.useRef();
  ...
  var previousIndex = React6.useRef();
  ...
  return React6.createElement(Component, _extends({
    ...
    }), mark.label != null ? React6.createElement("span", {
      "aria-hidden": true,
      "data-index": index,
      style,
    ...
    var style = axisProps[axis].offset(percent);
    return React6.createElement(ValueLabelComponent, {
      key: index,
      valueLabelFormat,
      valueLabelDisplay,
      ...
      disabled
    }, React6.createElement(ThumbComponent, {
